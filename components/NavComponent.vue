...
<template>
  <nav class="mt-16 w-max">
    <NuxtLink class="group flex items-center py-3 active" to="/">
      <span
    ...
    <NuxtLink class="group flex items-center py-3 active" to="/experience">
      <span
        class="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"
      ></span
      ><span
    ...
    <NuxtLink class="group flex items-center py-3 active" to="/projects">
      <span
        class="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"
      ></span
      ><span
